 ...
 */
public class EMREvent implements Serializable {
    ...
    public EMREvent(EMREventObject object) {
        if (object != null) {
            ...
            this.setKeyBatchId(object.getKeyBatchId());
            this.setPriceStatusCode(object.getPriceStatusCode());
            this.setIsPriced(object.getIsPriced());
            this.setScanDateTime(object.getScanDateTime());
