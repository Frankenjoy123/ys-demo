...
public class OperationLog {
    ...
    @JsonProperty("created_app_name")
    private String createdAppName;

    public String getCreatedAppName() {
        return createdAppName;
    }

    public void setCreatedAppName(String createdAppName) {
        this.createdAppName = createdAppName;
    }
    ...
    public OperationLog(OperationLogObject object){
