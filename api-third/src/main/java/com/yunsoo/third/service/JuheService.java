...
public class JuheService {
    ...
    //话费充值
    public JuheMobileOrderResult mobileOrder(String mobile, int number, String orderId) {
    ...
    //流量充值
    public JuheMobileDataResult mobileDataFlow(String mobile, int pid,  String orderId) {
    ...
    public JuheSMSResult sendSMS(String mobile, String tempId, HashMap<String, String> variables) throws UnsupportedEncodingException {
    ...
    public JuheMobileLocationResult getMobileLocation(String mobile){
        if(mobile == null)
            return null;
