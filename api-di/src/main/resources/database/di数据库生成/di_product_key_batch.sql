...
--
-- Table structure for table `product_key_batch`
--
...
CREATE TABLE `product_key_batch` (
  `id` char(19) NOT NULL,
  `partition_id` char(19) DEFAULT NULL,
  `batch_no` varchar(20) DEFAULT NULL,
  `quantity` int(11) NOT NULL,
  `status_code` varchar(20) NOT NULL,
  `product_key_type_codes` varchar(60) DEFAULT NULL,
  `product_status_code` varchar(20) DEFAULT NULL,
  `product_base_id` char(19) DEFAULT NULL,
  `org_id` char(19) DEFAULT NULL,
  `created_app_id` char(19) DEFAULT NULL,
  `created_device_id` varchar(40) DEFAULT NULL,
  `created_account_id` char(19) DEFAULT NULL,
  `created_datetime` datetime NOT NULL,
  `marketing_id` char(19) DEFAULT NULL,
  `download_no` smallint(6) DEFAULT '0',
  PRIMARY KEY (`id`),
...
-- Dump completed on 2016-12-13 13:56:21
