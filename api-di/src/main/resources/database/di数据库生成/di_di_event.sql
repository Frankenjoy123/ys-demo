...
CREATE TABLE `di_event` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_org_user_ys` (`org_id`,`user_id`,`ys_id`),
  KEY `idx_event_id` (`event_id`,`name`),
  KEY `idx_location_id` (`location_id`),
  KEY `idx_time_id` (`time_id`),
  KEY `idx_useragent` (`user_agent_id`),
  KEY `idx_prod` (`product_base_id`),
  KEY `idx_event_datetime` (`event_datetime`)
) ENGINE=InnoDB AUTO_INCREMENT=11036 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2016-12-13 13:56:18
