    ...
    function getStandardFormat(format, pc) {
      switch (format) {
        case 'd':
          return 'M/d/yyyy';
        case 'D':
          return 'WWWW, MMMM dd, yyyy';
        case 'f':
          return 'WWWW, MMMM dd, yyyy h:mm tt';
        case 'F':
          return 'WWWW, MMMM dd, yyyy h:mm:ss tt';
        case 'g':
        ...
        case 'R':
          return 'WWW, dd MMM yyyy H:mm:ss ' + pc.push('GMT').name;
        case 's':
