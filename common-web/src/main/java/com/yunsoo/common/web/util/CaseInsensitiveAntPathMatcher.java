 ...
 * Created by:   Lijian
 * Created on:   2015/3/9
 * Descriptions: It implements exactly the same as AntPathMatcher, but it's case insensitive.
 *               Modified the code from AntPathMatcher by changing the AntPathStringMatcher to case insensitive.
 */
public class CaseInsensitiveAntPathMatcher implements PathMatcher {
     ...
     */
    public CaseInsensitiveAntPathMatcher() {
     ...
     * @since 4.1
     */
    public CaseInsensitiveAntPathMatcher(String pathSeparator) {
    ...
    protected static class AntPathStringMatcher {
        ...
        public AntPathStringMatcher(String pattern) {
            ...
            this.pattern = Pattern.compile(patternBuilder.toString(), Pattern.CASE_INSENSITIVE);//case insensitive pattern
        }
