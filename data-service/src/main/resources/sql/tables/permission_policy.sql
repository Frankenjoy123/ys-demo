...
VALUES
  ...
  ('enterprise_page_account_view', 'Account View', '账号查看', 'enterprise_page_account:read,account:read,permission_allocation:read'),
  ('enterprise_page_account_manage', 'Account Manage', '账号管理', 'enterprise_page_account:write,account:*,permission_allocation:*'),
  ('enterprise_page_group_view', 'Group View', '账号组查看', 'enterprise_page_group:read,group:read,permission_allocation:read'),
  ('enterprise_page_group_manage', 'Group Manage', '账号组管理', 'enterprise_page_group:write,group:*,permission_allocation:*'),
