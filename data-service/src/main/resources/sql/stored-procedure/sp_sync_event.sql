...
SELECT 'scan', case when usr.user_id = '0020000000000000000' then null else usr.user_id END, usr.ysid,
...
-- 插入营销事件
insert into sp_sync_event_tmp_event
SELECT 'draw', case when usr.user_id = '0020000000000000000' then null else usr.user_id END, usr.ysid,
