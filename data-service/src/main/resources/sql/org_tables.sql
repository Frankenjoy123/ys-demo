...
VALUES
  ('2k0r1l55i2rs5544wz5', '云溯科技', 'tech', 'available', '关注互联网+的力量!', NULL, '详细描述信息', '1'),
  ('2k0r2yvydbxbvibvgfm', '某凉茶有限公司', 'manufacturer', 'available', '喝凉茶，不上火', NULL, '', '1'),
  ('2k0r306o609oljxd1wz', '某山泉水公司', 'manufacturer', 'available', '大自然的搬运工', NULL, '', '1');
